...
public interface IScenegraphRenderer
{
  ...
  /**
   * pass all lights to renderer
   * @param allLights
   */
  void getAllLight(List<Light> allLights);

  /**
   * is actually draw light by sending lights to shader
   * @param lights
   */
   ...
   * @throws Exception
   */
  void addTexture(String name, TextureImage texture) throws Exception;
}
