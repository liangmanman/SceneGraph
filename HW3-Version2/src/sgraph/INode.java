...
public interface INode
{
  ...
  /**
   * return all lights in view transform
   *
   * @param result
   * @param modelView
   */
    void descendLights(List<Light> result, Matrix4f modelView);

  /**
   * apply acc to it make object in vew transform
   * @param acc
   * @param modelView
   * @return
   */
  Matrix4f objectToView(Matrix4f acc, Matrix4f modelView);

    void transformedToLight(Matrix4f objectToView, List<Light> transformedLights);
}
